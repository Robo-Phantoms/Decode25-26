...
@Autonomous(name = "SoloRed", group = "Regional Championship Autos")
public class SoloRedAuto extends NextFTCOpMode {
    public SoloRedAuto(){
        addComponents(
    ...
    private final  Pose scorePose = new Pose(35, 116, Math.toRadians(144)).mirror();
    private final Pose line2StartPose = new Pose(42, 60, Math.toRadians(180)).mirror();
    private final Pose line2EndPose = new Pose(20, 60, Math.toRadians(180)).mirror();
    private final Pose openGatePose = new Pose(22, 66, Math.toRadians(180)).mirror();
    private final Pose gateIntakePose = new Pose(13, 56, Math.toRadians(150)).mirror();
    private final Pose line1StartPose = new Pose(45, 84, Math.toRadians(180)).mirror();
    private final Pose line1EndPose = new Pose(20, 84, Math.toRadians(180)).mirror();
    private final Pose line3StartPose = new Pose(45, 36, Math.toRadians(180)).mirror();
    private final Pose line3EndPose = new Pose(20, 36, Math.toRadians(180)).mirror();
    private final Pose leavePose = new Pose(43, 127, Math.toRadians(144)).mirror();
    ...
    private final Pose cGateIntake = new Pose(33, 54).mirror();
    ...
    public void onInit(){
        ...
        line2 = follower().pathBuilder()
                ...
                .setHeadingInterpolation(
                        HeadingInterpolator.piecewise(
                                ...
                                HeadingInterpolator.PiecewiseNode.linear(0.7, 1.0, follower().getHeading(), line2StartPose.getHeading())
                        )
                )
        ...
        score2 = follower().pathBuilder()
                ...
                .setHeadingInterpolation(
                        HeadingInterpolator.piecewise(
                                new HeadingInterpolator.PiecewiseNode(0.0, 0.7, HeadingInterpolator.tangent),
                                HeadingInterpolator.PiecewiseNode.linear(0.7, 1.0, follower().getHeading(), scorePose.getHeading())
                        )
                )
                .build();
        ...
        line3 = follower().pathBuilder()
                ...
                .setHeadingInterpolation(
                        HeadingInterpolator.piecewise(
                                new HeadingInterpolator.PiecewiseNode(0.0, 0.7, HeadingInterpolator.tangent),
                                HeadingInterpolator.PiecewiseNode.linear(0.7, 1.0, follower().getHeading(), line3StartPose.getHeading())
                        )
                )
