...
public class Poses {
    ...
    public static class LM4BluePoses{
        ...
        public static final Pose line2Start = new Pose(36, 55, Math.toRadians(180));
        public static final Pose line2End = new Pose(20, 55, Math.toRadians(180));
        public static final Pose openGate = new Pose(27, 64, Math.toRadians(180));
        public static final Pose openGateIntake = new Pose(8, 58, Math.toRadians(130));
        public static final Pose line1Start = new Pose(36, 79, Math.toRadians(180));
        public static final Pose line1End = new Pose(20, 79, Math.toRadians(180));
        public static final Pose line3Start = new Pose(36, 33, Math.toRadians(180));
        public static final Pose line3End = new Pose(20, 33, Math.toRadians(180));
