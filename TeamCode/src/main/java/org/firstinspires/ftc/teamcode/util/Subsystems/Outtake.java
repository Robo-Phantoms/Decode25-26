...
public class Outtake implements Subsystem {
    ...
    public static double targetVel=1850;
    private ControlSystem controller = ControlSystem.builder()
            .velPid(0.0009, 0 , 0)
            .basicFF(0.00031, 0, 0)
            .build();

    public Command shootArtifact = new RunToVelocity(controller, 1850);
    public Command stopShooting = new RunToVelocity(controller, 0);
