...
public class blueAuto extends NextFTCOpMode {
    ...
    private final Pose2d firstLineStartPose = new Pose2d(-4, -28, Math.toRadians(270));
    ...
    public void onInit(){
        ...
        secondCycle = drive.commandBuilder(new Pose2d(-5, -44, Math.toRadians(270))).fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-30,-27), Math.toRadians(220)), Math.toRadians(220))
                .build();

        secondLineStart = drive.commandBuilder(new Pose2d(-30, -27, Math.toRadians(220))).fresh()
