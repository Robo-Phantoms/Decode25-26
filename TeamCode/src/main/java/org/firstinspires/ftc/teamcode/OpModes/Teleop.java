...
public class Teleop extends NextFTCOpMode {
    ...
    public void onStartButtonPressed() {
        button(() -> Intake.INSTANCE.getCount() > 3).whenTrue(
                new SequentialGroup(Intake.INSTANCE.reverse, new Delay(0.5), new InstantCommand(() -> Intake.INSTANCE.resetCount())).setInterruptible(false)
        );
