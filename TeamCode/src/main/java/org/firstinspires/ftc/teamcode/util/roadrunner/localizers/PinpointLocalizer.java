...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1497.784870908201; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3544.0031562030463; // x position of the perpendicular encoder (in tick units)
    }
