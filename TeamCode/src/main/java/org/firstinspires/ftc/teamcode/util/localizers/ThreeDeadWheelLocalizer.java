...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1435.4067495590655; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1500.7650820857423; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3438.475652897838; // x position of the perpendicular encoder (in tick units)
    }
