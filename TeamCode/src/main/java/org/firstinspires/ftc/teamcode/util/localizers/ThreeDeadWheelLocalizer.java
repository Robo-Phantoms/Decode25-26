...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1229.087102448427; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1598.4038489956815; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3489.9616694968568; // x position of the perpendicular encoder (in tick units)
    }
